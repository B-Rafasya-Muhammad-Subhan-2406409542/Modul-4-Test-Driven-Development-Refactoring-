...
class CreateCarFunctionalTest {
    ...
    @Test
    void createCar_isCorrect(ChromeDriver driver) {
        driver.get(baseUrl + "/car/createCar");

        WebElement nameInput = driver.findElement(By.id("nameInput"));
        nameInput.clear();
        nameInput.sendKeys("Toyota Supra");
        ...
        assertTrue(pageSource.contains("Toyota Supra"));
        assertTrue(pageSource.contains("Orange"));
